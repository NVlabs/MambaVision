...
#SBATCH --exclusive
#SBATCH --overcommit
#SBATCH --job-name=mamba_vision_160k_ade20k-512x512_small
...
NAME="mamba_vision_160k_ade20k-512x512_small"
IMAGE="<your_image>"  # provide your image here

CONFIG=./configs/mamba_vision/mamba_vision_160k_ade20k-512x512_small.py
